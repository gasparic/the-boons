(function($){
	...
	$(document).ready(function(){
		for(var i=0, decks=$('.slidedeck_frame.skin-vertical-dark'); i<decks.length; i++){
			var thisDeck = decks[i];
		    
			if(typeof(thisDeck.SlideDeck_skinVerticalDark) == 'undefined'){
				thisDeck.SlideDeck_skinVerticalDark = VerticalDark(thisDeck);
			}
		}
	});
})(jQuery);