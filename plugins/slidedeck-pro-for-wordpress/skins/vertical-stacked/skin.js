(function($){
    SlideDeckSkin['vertical-stacked'] = function(slidedeck){
        var ns = 'vertical-stacked';
        var elems = {};
    ...
    $(document).ready(function(){
        $('.skin-vertical-stacked .slidedeck').each(function(){
            new SlideDeckSkin['vertical-stacked'](this);
        });
    });
})(jQuery);
