(function($){
    SlideDeckSkin['vertical-stacked-arrow'] = function(slidedeck){
        var ns = 'vertical-stacked-arrow';
        var elems = {};
        ...
        elems.horizontalSlides.each(function(){
            ...
            var slideElems = {};
				...
				slideElems.verticalElems.append('<span class="triangle" />');
				slideElems.triangles = slideElems.verticalElems.find('span.triangle');
			...
			slideElems.triangles.each(function(){
				var $elem = $(this);
				var elemParent = $elem.closest('li');
				var elemHeight = elemParent.outerHeight(true);
				$elem.css({
					borderTop: elemHeight/2 + 'px solid transparent',
					borderBottom: elemHeight/2 + 'px solid transparent'
				});
			});
        });
    ...
    $(document).ready(function(){
        $('.skin-vertical-stacked-arrow .slidedeck').each(function(){
            new SlideDeckSkin['vertical-stacked-arrow'](this);
        });
    });
})(jQuery);
