(function($){
    SlideDeckSkin['stacked-nav-arrow'] = function(slidedeck){
        var ns = 'stacked-nav-arrow';
        var elems = {};
    ...
    $(document).ready(function(){
        $('.skin-stacked-nav-arrow .slidedeck').each(function(){
            new SlideDeckSkin['stacked-nav-arrow'](this);
        });
    });
})(jQuery);
