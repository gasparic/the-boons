			...
			<div class="inner-sidebar">
				<div id="slidedeck-options" class="postbox">
					...
					<div class="inside">
						...
						<div class="misc-pub-section">
                            <label><input type="checkbox" name="slidedeck_options[touch]" value="true"<?php echo slidedeck_get_option( $slidedeck, 'touch' ) == 'true' ? ' checked="checked"' : ''; ?> /> Allow Touch Screen Swipe Interaction</label>
                            <?php $touch_threshold = slidedeck_get_option( $slidedeck, 'touchThreshold' ); ?>
                            <label style="display:inline">With a threshold of <input type="text" name="slidedeck_options[touchThreshold][x]" value="<?php echo $touch_threshold['x'] ?>" size="3" maxlength="3" /> px horizontally and </label>
                            <label style="display:inline"> <input type="text" name="slidedeck_options[touchThreshold][y]" value="<?php echo $touch_threshold['x'] ?>" size="3" maxlength="3" /> px vertically</label>
